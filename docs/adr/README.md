...
| -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------- | ----------------------------------------------------------------------------------------- |
| [ADR-046](0046-settings-is-one-area-with-a-group-per-scope.md)             | Settings is one area, with a sidebar group per scope                                            | 2026-09-07      | Accepted                                                                                  |
| [ADR-045](0045-components-are-grouped-by-domain-and-a-component-with.md)   | Components are grouped by domain, and a component with one caller lives with it                 | 2026-09-07      | Accepted                                                                                  |
| [ADR-044](0044-the-control-scale-is-one-step-tighter-than-vega-the.md)     | The control scale is one step tighter than Vega; the spacing scale is not                       | 2026-09-07      | Accepted                                                                                  |
| [ADR-043](0043-the-style-is-aria-vega-at-large-radius-with-app-level.md)   | The style is aria-vega at large radius, with app-level variants                                 | 2026-09-07      | Accepted                                                                                  |
| [ADR-042](0042-one-menu-bar-and-a-real-sidebar-for-resource-sections.md)   | One menu bar, and a real sidebar for resource sections                                          | 2026-09-07      | Accepted                                                                                  |
