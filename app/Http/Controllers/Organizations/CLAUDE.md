...
[ADR-025](../../../../docs/adr/0025-team-becomes-organization-the-personal-team-is-removed.md) through [ADR-031](../../../../docs/adr/0031-tenant-routes-sit-behind-a-literal-org-segment.md). Do not
...
([ADR-026](../../../../docs/adr/0026-app-stays-type-first-with-a-domain-subfolder-inside.md)), organization code is not all here:
...
| Notifications         | `app/Notifications/Organizations/OrganizationInvitation.php` — queued ([ADR-023](../../../../docs/adr/0023-invitation-emails-are-rate-limited-and-queued.md))                                                                                                                   |
...
| Audit log             | `app/Models/Audit/AuditLogEntry.php`, `app/Enums/Audit/AuditAction.php`, `app/Actions/Audit/RecordAuditEntry.php` — its own domain, since `Server` and `Site` will write to it too ([ADR-032](../../../../docs/adr/0032-an-append-only-audit-log-built-now-while-there-are.md)) |
...
current organization** ([ADR-025](../../../../docs/adr/0025-team-becomes-organization-the-personal-team-is-removed.md), phase 3): a read must not
...
administration alike — under `/org/{organization}/…` ([ADR-031](../../../../docs/adr/0031-tenant-routes-sit-behind-a-literal-org-segment.md)).
...
5. **Never let `OrganizationHandle` validation be skipped.** It enforces shape (a slug) and
   ...
   ([ADR-006](../../../../docs/adr/0006-slug-uniqueness-includes-soft-deleted-teams.md), [ADR-030](../../../../docs/adr/0030-the-tenant-url-identifier-is-a-name-seeded-separately.md)) — not
   reserved words. That list existed once (ADR-008) and was retired for good by
   [ADR-031](../../../../docs/adr/0031-tenant-routes-sit-behind-a-literal-org-segment.md): behind the literal `org/` segment a handle can no
...
9. **A new membership or invitation event gets an audit entry.** Inject `RecordAuditEntry` and
   ...
   same request that audits them ([ADR-032](../../../../docs/adr/0032-an-append-only-audit-log-built-now-while-there-are.md)). This is not "add
