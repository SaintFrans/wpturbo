...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    /*
     * Team administration sits with the account settings rather than in the top navigation
     * (ADR-016, revised). Everything scoped to a single team keeps EnsureTeamMembership;
     * the index lists every team the user belongs to, so it is not tenant-scoped.
     */
