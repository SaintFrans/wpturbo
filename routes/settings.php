...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    /*
     * Organization administration sits with the account settings rather than in the top navigation
     * (ADR-016, revised). Everything scoped to a single organization keeps EnsureOrganizationMembership;
     * the index lists every organization the user belongs to, so it is not tenant-scoped.
     */
