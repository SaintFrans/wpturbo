...
/**
 * The wordmark, for the auth pages: the mark plus "Hestri".
 */
export function AppLogo(props: SVGAttributes<SVGElement>) {
    return (
        <svg
            {...props}
...
/**
 * The mark alone, for the menu bar and anywhere else the wordmark would not fit.
 */
